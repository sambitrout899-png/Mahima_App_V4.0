...
export default function PayrollPage() {
  ...
  useEffect(() => {
    ...
    const loadStaff = async () => {
      try {
        // If you use another endpoint, adjust here (e.g. /users?role=Staff)
  ...
  useEffect(() => {
    ...
    const loadSettings = async () => {
      try {
        const res = await axios.get("/payroll/settings");
        const all = res.data || [];
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const res = await axios.get("/payroll/summary", { params });
  ...
  const handleDownloadSlip = async () => {
    ...
    try {
      ...
      const res = await axios.get("/payroll/slip", {
        params,
        responseType: "blob",
      });
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      await axios.post("/payroll/settings", payload);
