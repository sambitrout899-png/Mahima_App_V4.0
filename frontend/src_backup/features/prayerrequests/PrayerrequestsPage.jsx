...
// will be: http://localhost:5001/api/prayerrequests in dev
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-white to-indigo-50 py-8 px-4">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {/* NEW ADMIN RECORDS SECTION – LOOK LIKE MARRIAGE LIST */}
        {isAdmin && (
              ...
              <table className="min-w-full text-xs sm:text-sm">
                ...
                <tbody>
                  {sortedRequests.map((req) => (
                    ...
                    >
                      <td className="px-4 py-2 align-top whitespace-nowrap text-slate-800">
                        {req.anonymous ? "Anonymous" : req.createdBy || "Member"}
                      </td>
                      <td className="px-4 py-2 align-top whitespace-nowrap text-slate-800">
                        {req.title || "—"}
                      ...
                      <td className="px-4 py-2 align-top whitespace-nowrap text-slate-600 text-xs">
                        {new Date(req.createdAt).toLocaleDateString()}{" "}
                        <span className="block text-[10px] text-slate-400">
                          {new Date(req.createdAt).toLocaleTimeString()}
                        </span>
                      </td>
                      <td className="px-4 py-2 align-top text-center text-slate-700">
