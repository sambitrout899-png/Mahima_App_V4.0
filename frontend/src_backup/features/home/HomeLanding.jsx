...
const translations = {
  en: {
    ...
    "hero.nightPrayer": "Night Prayer - every Friday 10:30 pm onwards",
    ...
    "serveModal.body":
      "Please contact Mr. Andreas Masih for team assignments, training and scheduling.",
...
function TopNav({ onOpenDonate }) {
  ...
  return (
    <header className="flex items-center justify-between py-3 sm:py-4 relative">
      ...
      <nav className="hidden sm:flex items-center gap-3">
        <a
          href="#about"
          className="px-3 py-2 text-sm text-rose-700 dark:text-rose-300 hover:underline"
        >
          {t("nav.about")}
        </a>
        <a
      ...
      >
        <div className="p-4 sm:p-8 md:p-12 flex flex-col justify-center gap-3 sm:gap-4">
          ...
          <figure className="mt-2 w-56 sm:w-64 md:w-80 rounded-xl overflow-hidden bg-white shadow border border-rose-100">
            <img
              src={posterPrimary}
              alt="From Glory to Grace — poster"
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            >
              <Users size={16} /> {t("hero.joinGroup")}
            </a>
        ...
        >
          <div className="absolute left-4 sm:left-6 top-4 sm:top-6 rounded-xl bg-white/80 p-3 shadow backdrop-blur-sm w-40 sm:w-44 transform -rotate-2">
            <div className="text-xs text-gray-500">
              {t("hero.upcomingCardTitle")}
            </div>
            {tasks[0] ? (
              <>
              ...
              <>
                <div className="font-semibold text-rose-700">
                  {t("hero.fallbackEventTitle")}
                </div>
                <div className="text-xs text-gray-500 mt-1">
                  {t("hero.fallbackEventTime")}
                </div>
              </>
            )}
          </div>

          <div className="absolute right-4 sm:right-6 bottom-6 rounded-xl bg-white/90 p-3 shadow backdrop-blur-sm w-40 sm:w-44 transform rotate-3">
            <div className="text-xs text-gray-500">{t("hero.joinUs")}</div>
            <div className="font-semibold text-rose-700">
              {t("hero.kidsClub")}
            </div>
            <div className="text-xs text-gray-500 mt-1">
          ...
          <svg
            className="absolute right-0 bottom-0 w-48 sm:w-56 h-48 sm:h-56 opacity-40"
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
          >
            <defs>
            ...
            <path
              fill="url(#lg)"
              d="M43.1,-33.8C54.4,-21.8,63.8,-0.7,61.7,17.6C59.6,35.9,46,52.3,27.6,61.5C9.1,70.6,-14.3,72.6,-31.8,63.1C-49.3,53.6,-61.9,32.6,-63.8,11.8C-65.7,-9.1,-56.9,-28,-41.7,-39.7C-26.6,-51.4,-13.3,-56,4.3,-59.4C21.8,-62.9,43.6,-64.7,43.1,-33.8Z"
    ...
    >
      ...
      <aside className="rounded-2xl bg-gradient-to-b from-rose-50 to-amber-50 dark:from-white/10 dark:to-white/5 p-6 shadow">
        ...
        <div className="mt-3 text-sm text-gray-700 dark:text-gray-300 space-y-2">
          ...
          <div className="flex items-center gap-2">
            <MessageSquare size={16} /> Andreas@mahimaministies.com
          </div>
          <div>
      ...
      <div className="rounded-2xl bg-rose-50 dark:bg-white/10 p-6 shadow flex flex-col justify-between">
        <div>
          ...
          <div className="mt-3 text-sm text-gray-700 dark:text-gray-300">
            ...
            <br />
            Email: Andreas@mahimaministies.com
            <br />
        ...
        <Modal onClose={() => setShowServeModal(false)}>
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-xl w-96 relative">
            ...
            <div className="text-sm text-gray-700 dark:text-gray-300">
              <div>
                <strong>{t("serveModal.contactLabel")}</strong> Andreas Masih
              </div>
              <div>
                <strong>{t("serveModal.phoneLabel")}</strong> +91 63726 04581
              </div>
              <div className="mt-3 text-xs text-gray-500 dark:text-gray-400">
